app.controller("businessManagement.ecommerce.client", function($scope, $state, $users, $stateParams, $http, Flash) {
  ...
  views = [{
    ...
    itemTemplate: '/static/ngTemplates/app.ecommerce.client.item.html',
  }, ];


  $scope.config = {
    views: views,
    url: '/api/ecommerce/client/',
    searchField: 'name',
    deletable: true,
...
app.controller("businessManagement.ecommerce.client.item", function($scope, $state, $users, $stateParams, $http, Flash) {


  $scope.deleteCard = function(){
    $http({method : 'DELETE' , url : '/api/ecommerce/client/'+ $scope.data.pk + '/' }).
...
app.controller("businessManagement.ecommerce.client.explore", function($scope, $state, $users, $stateParams, $http, Flash) {
  ...
  $http({
    method: 'GET',
    url: '/api/ecommerce/client/' + $scope.tab.data.pk + '/'
  }).
  then(function(response) {
...
app.controller("businessManagement.ecommerce.client.form", function($scope, $state, $users, $stateParams, $http, Flash) {
  ...
  $scope.$watch('form.company', function(newValue, oldValue) {
    ...
    $scope.setDate = function(year, month, day) {
      $scope.dt = new Date(month, year, day);
    };
  ...
  $scope.createContact = function(){
    ...
    if ($scope.form.title != '' && $scope.form.title != null) {
      fd.append('title', $scope.form.title);
    }

    if ($scope.form.details != '' && $scope.form.details != null) {
      fd.append('details', $scope.form.details);
    }

    if ($scope.form.dt != '' && $scope.form.dt != null) {
      fd.append('dt', $scope.form.dt);
    }
